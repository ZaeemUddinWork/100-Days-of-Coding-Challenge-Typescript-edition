...
*/
//saving famous person name
let famous_person: string = 'Muhammad Ali Jinnah';

//saving quote 
let quote: string = '"Think well before selecting your leader, and when you have selected him, follow him."'

//printing quoe with person name !!
