...
*/
//printing name with quote !!
console.log(`Muhammad Ali Jinnah once said,"No nation can rise to the height of glory unless your women are side by side with you."`);
