...
for (let table_no = 1 /*saving table no*/; table_no <= 5; table_no++ /* it will increase table no after every loop*/) { //printing titel for all tables 
    console.log(`\n\tMultiplication Table of No.: ${table_no}`);
    for (let number = 1; number <= 10; number++) { //printing table like 1 x 1 = 1 
