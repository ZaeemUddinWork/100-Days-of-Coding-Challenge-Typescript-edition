...
{
    console.log(`You shot down ${alien_color} alien, You got 50 points\n`)
}
else if (alien_color == 'Red')
{
    console.log(`You shot down ${alien_color} alien, You got 25 points\n`)
}
else if (alien_color == 'Yellow')
{
    console.log(`You shot down ${alien_color} alien, You got 10 points\n`)
}
else
{
