...
*/
//old user data
let old_username = ['Zaeem', 'MaRiA', 'Aliyan', 'MARK'];
//new user data
let new_username = ['zAEEm', 'Alisa', 'maria', 'Goku', 'aliyan', 'Taha', 'MaRk'];
//for earch of new user to compare all data of new user to old user
new_username.forEach(element => {
    if (old_username.some(old_user => old_user.toLocaleLowerCase() === element.toLocaleLowerCase())) //by this it will convert both into lower case to compare
